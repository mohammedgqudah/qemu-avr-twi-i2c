...
use qemu_api::{
    bindings::*, c_str, vmstate_fields, vmstate_unused, zeroable::Zeroable,
};
...
qemu_api::device_class_init! {
    twi_i2c_class_init,
    props => TWI_I2C_PROPERTIES,
    realize_fn => Some(twi_i2c_realize),
    legacy_reset_fn => Some(twi_i2c_reset),
    vmsd => VMSTATE_TWI_I2C,
}
